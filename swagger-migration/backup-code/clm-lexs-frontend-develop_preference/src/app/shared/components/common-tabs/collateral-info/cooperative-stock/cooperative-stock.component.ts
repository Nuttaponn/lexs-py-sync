...
@Component({
  selector: 'app-cooperative-stock',
  templateUrl: './cooperative-stock.component.html',
  styleUrls: ['./cooperative-stock.component.scss'],
})
export class CooperativeStockComponent implements OnInit {
