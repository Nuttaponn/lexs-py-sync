...
export interface AuctionCashierTransferOwnershipApprovalRequest { 
    headerFlag?: AuctionCashierTransferOwnershipApprovalRequest.HeaderFlagEnum;
    taskId?: number;
    rejectReason?: string;
    id?: number;
}
export namespace AuctionCashierTransferOwnershipApprovalRequest {
