...
export interface PersonHeirInfoDto { 
    birthDate?: string;
    ...
    name?: string;
    personId?: string;
    personType?: PersonHeirInfoDto.PersonTypeEnum;
    reason?: string;
    referencePersonId?: string;
    relation?: PersonHeirInfoDto.RelationEnum;
    selected?: boolean;
    title?: string;
    updateFlag?: PersonHeirInfoDto.UpdateFlagEnum;
}
export namespace PersonHeirInfoDto {
