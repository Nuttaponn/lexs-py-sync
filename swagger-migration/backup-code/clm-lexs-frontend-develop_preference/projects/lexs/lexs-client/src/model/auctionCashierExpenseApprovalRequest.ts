...
export interface AuctionCashierExpenseApprovalRequest { 
    headerFlag?: AuctionCashierExpenseApprovalRequest.HeaderFlagEnum;
    taskId?: number;
    rejectReason?: string;
}
export namespace AuctionCashierExpenseApprovalRequest {
