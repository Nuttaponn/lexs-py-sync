...
export interface DefermentHeaderDetails { 
    ...
    customerId?: string;
    customerName?: string;
    customerStatus?: DefermentHeaderDetails.CustomerStatusEnum;
    customerStatusName?: string;
    defermentStatus?: DefermentHeaderDetails.DefermentStatusEnum;
    defermentStatusName?: string;
    litigationId?: string;
    responseUnitCode?: string;
    responseUnitName?: string;
}
export namespace DefermentHeaderDetails {
