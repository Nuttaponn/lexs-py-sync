 ...
 */
import { AdditionalPaymentDocument } from './additionalPaymentDocument';


export interface AuctionCashierAdditionalPaymentSubmitRequest { 
    ...
    additionalPaymentDocs?: AdditionalPaymentDocument;
}
export namespace AuctionCashierAdditionalPaymentSubmitRequest {
