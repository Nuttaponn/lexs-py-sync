...
export interface AuctionCashierStampDutySubmitRequest { 
    headerFlag?: AuctionCashierStampDutySubmitRequest.HeaderFlagEnum;
...
export namespace AuctionCashierStampDutySubmitRequest {
