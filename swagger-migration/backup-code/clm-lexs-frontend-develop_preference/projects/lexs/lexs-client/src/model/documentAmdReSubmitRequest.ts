 ...
 */
import { AmdDocument } from './amdDocument';


export interface DocumentAmdReSubmitRequest { 
    /**
     * Header Flag // DRAFT,SUBMIT
     */
    headerFlag: DocumentAmdReSubmitRequest.HeaderFlagEnum;
    documents?: Array<AmdDocument>;
}
export namespace DocumentAmdReSubmitRequest {
