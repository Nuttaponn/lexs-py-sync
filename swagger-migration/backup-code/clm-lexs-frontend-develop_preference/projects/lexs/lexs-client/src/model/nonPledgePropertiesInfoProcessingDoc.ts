...
export interface NonPledgePropertiesInfoProcessingDoc { 
    cifNo?: string;
    documentId?: number;
    ...
    imageId?: string;
    imageName?: string;
    imageSource?: NonPledgePropertiesInfoProcessingDoc.ImageSourceEnum;
    name?: string;
    relation?: NonPledgePropertiesInfoProcessingDoc.RelationEnum;
    taxId?: string;
    uploadTimestamp?: string;
}
export namespace NonPledgePropertiesInfoProcessingDoc {
