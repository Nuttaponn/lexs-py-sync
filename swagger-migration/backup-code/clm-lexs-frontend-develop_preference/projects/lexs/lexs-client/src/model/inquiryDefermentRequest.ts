...
export interface InquiryDefermentRequest { 
    customerId?: string;
    defermentType: InquiryDefermentRequest.DefermentTypeEnum;
    mode: InquiryDefermentRequest.ModeEnum;
    defermentId?: string;
    litigationId?: string;
    taskId?: number;
}
export namespace InquiryDefermentRequest {
