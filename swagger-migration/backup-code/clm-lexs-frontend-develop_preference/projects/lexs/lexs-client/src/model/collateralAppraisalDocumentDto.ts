...
export interface CollateralAppraisalDocumentDto { 
    documentId?: number;
    documentTemplate?: DocumentTemplateDto;
    documentNo?: string;
    imageSource?: CollateralAppraisalDocumentDto.ImageSourceEnum;
    imageId?: string;
    imageName?: string;
    appraisalDate?: string;
    relatedCollateral?: RelatedCollateral;
}
export namespace CollateralAppraisalDocumentDto {
