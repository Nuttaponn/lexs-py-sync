...
export interface AuctionCashierAdditionApprovalRequest { 
    headerFlag?: AuctionCashierAdditionApprovalRequest.HeaderFlagEnum;
    taskId?: number;
    rejectReason?: string;
}
export namespace AuctionCashierAdditionApprovalRequest {
