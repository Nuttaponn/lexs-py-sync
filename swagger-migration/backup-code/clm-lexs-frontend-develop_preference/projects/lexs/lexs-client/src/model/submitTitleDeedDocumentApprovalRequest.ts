 ...
 */
import { SeizureTitleDeedDocument } from './seizureTitleDeedDocument';


export interface SubmitTitleDeedDocumentApprovalRequest { 
    /**
     * Header Flag // DRAFT,SUBMIT
     */
    headerFlag: SubmitTitleDeedDocumentApprovalRequest.HeaderFlagEnum;
    documents?: Array<SeizureTitleDeedDocument>;
}
export namespace SubmitTitleDeedDocumentApprovalRequest {
